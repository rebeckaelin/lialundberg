...
import logo from "../assets/thumbnail_lia_transparent.png";
...
const Header = () => {
  ...
  return (
    <>
      <section className="flex justify-between pl-4 pr-8">
        <img
          className="w-[200px] lg:w-[280px] h-auto cursor-pointer"
          onClick={() => navigate("/")}
          src={logo}
          alt=""
        />
        ...
        <nav className="hidden sm:block my-4 uppercase ">
          <ul className="flex shadow-lg justify-center text-base lg:text-lg truncate h-full w-full items-center gap-10 font-second text-primary relative">
            <li>
              <Link
                to="/behandlingar"
